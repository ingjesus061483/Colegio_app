...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{url('/')}}">Colegio de prueba</a>
            <!-- Sidebar Toggle-->
        ...
        <script type="text/javascript">    
           var students=[];               
           $.ajax({
                url: "{{url('/estudiantes/CargarEstudiante')}}/{{isset($curso)?$curso:''}}",
                type: "GET",
                dataType: "json",
                success: function (result) 
                {
                    var estudiantes=result.estudiantes
                    var cont=0;
                    for(i=0;i<=estudiantes.length-1;i++)
                    {
                        students[cont]=estudiantes[i].identificacion+' - ' +estudiantes[i].estudiante
                        cont++;
                    }
                }            
            });        
